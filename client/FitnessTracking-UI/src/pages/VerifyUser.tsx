                ...
                <Container size="lg" className="relative z-10">
                    <div className="text-center mb-8 mt-8">
                        <Title order={1}
                            ...
                            You have been Registered to Fit Track Pro
                        </Title>
                        <Text c="gray.3" size="lg" mt="md">
                            Please verify yourself by entering the verification code that we have sent you to your email
                        </Text>
                    </div>
                    <VerifyForm showForm={showForm}/>
                </Container>
            </section>
        </div>
    );
